  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 overflow-x-hidden">
      ...
      <div className="container mx-auto px-4 mt-12">
        <Link href="/firsttime/" className="flex items-center justify-between bg-white rounded-xl px-6 py-4 border border-slate-100 hover:border-slate-200 hover:shadow-md transition-all group">
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="lg:w-2/3">
              ...
              <div className="space-y-4">
                ...
                <Link href="/archives/" className="w-full py-5 text-slate-900 font-black text-sm border-2 border-slate-100 rounded-2xl hover:bg-slate-900 hover:text-white transition-all flex items-center justify-center gap-2 mt-4">
