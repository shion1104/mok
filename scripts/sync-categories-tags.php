...
// WordPressを読み込む
$wp_load_paths = array(
    __DIR__ . '/../wordpress/wp-load.php',  // ローカル実行時
    __DIR__ . '/../../wordpress/wp-load.php', // Dockerコンテナ内実行時
    '/var/www/html/wp-load.php', // Dockerコンテナ内の絶対パス
);
...
if (!$wp_loaded) {
    die("WordPressが見つかりません。パスを確認してください。\n");
}
...
echo "\n=== 同期が完了しました ===\n";
echo "\n注意: 削除対象のカテゴリーとタグは表示のみです。\n";
echo "実際に削除する場合は、スクリプト内のコメントを外してください。\n";
